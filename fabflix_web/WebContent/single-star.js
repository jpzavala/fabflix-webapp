...
function handleResult(resultData) {
    ...
    starInfoElement.append("<h3 class='card-title'>" + resultData[0]["star_name"] + "</h3>");
    ...
    for (let i = 0; i < resultData.length; i++) {
        ...
        rowHTML += "<th>" +
            // Add a link to single-movie.html with movie_id passed with GET url parameter
...
jQuery.ajax({
    ...
    url: "api/single-star?id=" + starId, // Setting request url, which is mapped by SingleStarServlet in SingleStarServlet.java
